...
@NgModule({
  declarations: [AdminPanelComponent, ToursComponent, InsightsComponent, EditTourComponent, VisitorsAnalyticsComponent, VisitorsAnalyticsChartComponent, OperatorsComponent, ContactsComponent],
  imports: [
